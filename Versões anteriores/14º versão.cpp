...
#include <stdlib.h>
#include <conio.h>
int relatorio(int concordoP1, int concordoP4, int concordoP5, int neutroP5){
						...
						scanf("%d", &resposta);
							switch(resposta){
								...
								case 2:{
									...
									relatorio(concordoP1, concordoP4, concordoP5, neutroP5);
									pesquisa++;
									break;
								}
								case 3: {
